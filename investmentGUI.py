...
Chapter 8 example of a GUI-based version of the Investment Calculator app from Chapter 3. Also illustrates the use of the Text Area object.
...
class InvestmentGUI(EasyFrame):
	...
	# definition of the copute() function for event handling
	def compute(self):
